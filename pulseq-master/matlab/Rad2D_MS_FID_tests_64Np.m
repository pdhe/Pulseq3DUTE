...
Np =64; %Cartesian phase encodes - play around with this number later for evals
...
fname = ['Rad2D_MSpei_64np5slice_FID', num2str(Ns),'_',num2str(sliceThickness),'ktraj'];
uisave('ktrajs', fname );
%% Write to file
...
% % Display the first few lines of the output file
 s=fileread('Rad2D_MSpei_64np5slice_FID.seq');
